...
Oh! Also! I highly recommend using @RichStokes method `https://github.com/richstokes/SteamOS-Nvidia-Drivers` for the nVidia driver for any card that my method does not wish to work with, I personally am struggling to get my old method to work properly with my 4th Gen i7 with a nVidia GTX 1070 FTW card
