...
Oh! Also! I highly recommend using Rich Stokes method `https://github.com/richstokes/SteamOS-Nvidia-Drivers` for the nVidia driver for any card that my method does not wish to work with, I personally am struggling to get my old method to work properly with my 4th Gen i7 with a nVidia GTX 1070 FTW card, the driver installer will get most of the way through the install process then fail (this is also why you want to make backups because I flooded my root partition :( much sadness)
