...
# Fetch and populate the Arch Package Manager Key File with the Arch Linux key
sudo pacman-key --populate archlinux

# Fetch and populate the Arch Package Manager Key File with the Valve SteamOS Holo key
...
# Download the Linux x86_64 (64 bit) nVidia driver for your specific GPU from nVidias website (YES. I KNOW. It goes against what everyone says about installing the one that comes with the distro but this does work and it is up to date)
